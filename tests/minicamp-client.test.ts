...
test('cup commands are routed separately from resenha',()=>{
 for(const t of ['!comandos','!confronto Arthur x Lucas','!forçar resultado 123 4x3','!novacopa','!formato 4','!entrar','!resultado 432 3x2','!confirmar 432','!stats','!ajuda','2'])assert.equal(minicampCommand(t),true);
